...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
        <div class="stat-card">
            <div>
                <div class="label">Kritis (&gt;=90%)</div>
                <div class="value text-danger">{{ $bins->where('percentage','>=',90)->count() }}</div>
            </div>
    ...
    <div class="col-md-3">
        <div class="stat-card">
            <div>
                ...
                <div class="value text-warning">{{ $bins->whereBetween('percentage',[70,89])->count() }}</div>
            </div>
    ...
    <div class="col-md-3">
        <div class="stat-card">
            <div>
                ...
                <div class="value text-success">{{ $bins->where('percentage','<',70)->count() }}</div>
            </div>
